              ...
              <div className="col-lg-12 col-xl-7">
                <div className="about-one__content">
                  <div className="block-title text-left">
                    ...
                    <h2>Our Inusrance Products Gives You Peace of Mind</h2>
                  </div>
                  <p>
              ...
              <div className="col-lg-4">
                <div className="service-one__card">
                  ...
                  <div className="service-one__content">
                    ...
                    <h3>
                      <a href="service-details.html">Funeral Cover</a>
                    </h3>
                    <p>
              ...
              <div className="col-lg-4">
                <div className="service-one__card">
                  ...
                  <div className="service-one__content">
                    ...
                    <h3>
                      <a href="service-details.html">Healthcare Insurance </a>
                    </h3>
                    <p>
              ...
              <div className="col-lg-4">
                <div className="service-one__card">
                  ...
                  <div className="service-one__content">
                    ...
                    <h3>
                      <a href="service-details.html">Accisure Insurance</a>
                    </h3>
                    <p>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="why-choose__box">
                        ...
                        <p>
                          If you meet the expected requirements, youre
        ...
        <div className="client-carousel pt-90 pb-90 client-carousel__has-border-top">
          <div className="container">
            ...
            >
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <img src="assets/images/resources/brand-1-1.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                  <img src="assets/images/resources/brand-1-2.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                  <img src="assets/images/resources/brand-1-3.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                  <img src="assets/images/resources/brand-1-2.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                  <img src="assets/images/resources/brand-1-5.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                  <img src="assets/images/resources/brand-1-2.jpg" alt="" />
                </div>
